        ...
        if(ret < 0)                                                                                                                                                   
         ...
         {                                                                                                                                                            
             ...
             {                                                                                                                                                        
               ...
               printf("%s\t%d\t%d\t%c\t %d\t\t %d\t\t %d\t\t\t%d\t\t\t%d\n",resp.stu.name,resp.stu.roll,resp.stu.sem,resp.stu.gender,resp.stu.marks[0],resp.stu.marks[
1],resp.stu.marks[2],resp.stu.marks[3],resp.stu.marks[4]); }                                                                                                          
               if(resp.stu.sem==2){                                                                                                                                   
               ...
               if(resp.stu.sem==3){                                                                                                                                   
                       printf("Name\trollno\tSem\tGender\tMachnine learning\tjava\tpython\tdeep learning\toperating systems\n");                                      
                                      printf("%s\t%d\t%d\t%c\t\t%d\t\t %d\t%d\t\t%d\t\t%d\n",resp.stu.name,resp.stu.roll,resp.stu.sem,resp.stu.gender,resp.stu.marks[0
